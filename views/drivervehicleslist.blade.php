...
@section('title', 'User Vehicle Details')
 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">User Vehicle Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">User Vehicle Details</h3>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><form action="#" method="POST">
                       <a class="btn btn-info btn-sm" href="{{ url('vehiclebookings',$val->id)}}">Bookings</a>
