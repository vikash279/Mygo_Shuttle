...
<head>
  ...
  <title>Mygo Shuttle | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('dashboard') }}" class="brand-link">
      <img src="{!!asset('public/assets/image/logo111.jpeg')!!}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Mygo Shuttle</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('riders')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Riders</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('vehicles')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Vehicle Registartion Details</p>
                </a>
              </li>
          ...
          <!--     <li class="nav-item">
           ...
           <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('shuttlelist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Shuttle Routes</p>
                </a>
              </li>
           ...
           <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('driverbook')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Booking for Drivers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('riderbooking')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Booking of Riders</p>
                </a>
              </li>
 ...
 -->        <!--   <li class="nav-header">MISCELLANEOUS</li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020-2024 <a href="#">TechnoDroidz</a>.</strong>
    All rights reserved.
